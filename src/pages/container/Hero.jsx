  ...
  return (
    <section className="container mx-auto p-5 flex flex-col lg:flex-row justify-between  ">
      <div className="lg:mt-15 md:mt-12 lg:w-2/5">
        <h1 className="font-roboto text-dark-soft text-3xl text-center lg:text-left md:text-4xl lg:text-5xl font-semibold">
          Read the most <br /> interesting articles
        </h1>
        <p className="text-dark-thin mt-4 text-center md:text-xl lg:text-left ">
        ...
        <div className="flex flex-col lg:flex-row relative mt-7">
        ...
        <div className="flex flex-col items-start lg:flex-row lg:flex-none mt-4  py-2 text-sm  font-semibold gap-4">
          <span className="font-bold text-dark-thin w-24 italic">Popular Tags:</span>
          <ul className="flex flex-wrap items-center gap-4 text-primary ">
      ...
      <div className="lg:flex justify-end lg:w-1/2 hidden ">
